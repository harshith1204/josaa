...
import CollegeRagChatPanel from '@/components/CollegeRagChatPanel';
      ...
      <div className="min-h-screen pb-20">
        ...
        <div className="sticky top-0 z-20 bg-[#0a0a0c]/95 backdrop-blur-sm border-b border-white/5">
          <div className="flex items-center gap-3 px-4 py-3">
            <button onClick={() => { setSelectedCollege(null); setDetailTab('overview'); }} className="text-gray-400 hover:text-white">
        ...
        <div className="px-4 py-4">
          ...
          {/* ═══ ASK AI TAB ═══ */}
          {detailTab === 'ask' && (
            <CollegeRagChatPanel instituteName={selectedCollege.name} key={selectedCollege.name} />
          )}
        </div>
      </div>
    );
